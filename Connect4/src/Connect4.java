    ...
    public static void main(String[] args) {
            ...
            try {
                ...
                while (winner == false && turn <= 42) {
                    ...
                    do {
                        ...
                        System.out.print("Drop a ");
                                if(player == 'R'){System.out.print("Red ");}else{System.out.print("Yellow ");}
                                System.out.print("disk at column (0-6):  \n");
                        play = in.nextInt();

                        //validate play
                        validPlay = validate(play, grid);
                        if(validPlay == false){System.out.println("Please choose a number between 0 and 6");}
                ...
                if (winner) {
                    ...
                    System.out.println("Please only choose numbers between 0 and 6");
